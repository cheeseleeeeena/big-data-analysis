...
# render渲染網頁
def home(request):
    return render(request, 'app_top_keyword_ithome/home.html')

# read df
df_topkey = pd.read_csv('app_top_keyword_ithome/dataset/ithome_news_topkey_with_category_via_token_pos.csv', sep=',')
...
print("app_top_keywords_ithome--類別熱門關鍵字載入成功!")
